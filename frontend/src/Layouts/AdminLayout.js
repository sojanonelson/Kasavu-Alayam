        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
          <div className="bg-white  shadow-2xl p-6 max-w-md w-full border border-gray-100">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-xl font-bold text-gray-800 poppins-bold">
                Desktop Recommended
              </h2>
            </div>
            <p className="mb-6 text-gray-600 leading-relaxed">
              This admin dashboard is designed for larger screens. For optimal
              experience and full functionality, we recommend accessing it from
          ...
          >
            ...
            <nav className="space-y-1  rounded-lg  p-2">
              ...
              >
                ...
                <span className="text-sm"> Homepage Editor</span>
              </NavLink>
            ...
            <div className="mt-4 rounded-lg shadow-sm p-2">
              <button
                ...
                className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-red-500 hover:bg-red-50 transition-colors text-sm"
              >
