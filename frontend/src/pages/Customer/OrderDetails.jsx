  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white mt-10">
      <h1 className="text-3xl font-bold flex items-center gap-2 mb-6">
        <PackageCheck className="text-green-500" /> Order Summary
      </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="space-y-2">
          <h2 className="text-lg font-semibold flex items-center gap-2">
            <MapPin className="text-red-600" /> Shipping Address
          </h2>
      ...
      <div className="space-y-4">
        {order.products.map((item, idx) => (
          <div key={idx} className="flex items-start gap-4 bg-gray-50 p-4 rounded-lg shadow-sm">
            <img
